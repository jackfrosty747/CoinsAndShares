...
Namespace Charts
    Friend Class FAssets
        ...
        Friend Sub New(commonObjects As CCommonObjects)
            ...
            DtpHodlingsDate.Value = Now.Date
...
"
        ...
        Private Sub BtnHodlings_Click(sender As Object, e As EventArgs) Handles BtnHodlings.Click
            Try
                Cursor = Cursors.WaitCursor
                TxtHodlings.Text = GetHodlings(DtpHodlingsDate.Value)
            Catch ex As Exception
        ...
        Private Function GetHodlings(dt As Date) As String
