...
Namespace Rates.GoogleFinance
    Friend Class CGoogleFinance : Implements IRateProvider
        ...
        Friend Function GetNewRates(providerIds As IEnumerable(Of String)) As IEnumerable(Of CRate) Implements IRateProvider.GetNewRates
            ...
            Dim url = "https://www.google.com/finance/quote/" & Symbol
            Dim Web = New HtmlWeb()
            ...
            Dim result = navigator.SelectSingleNode("/html[1]/body[1]/c-wiz[2]/div[1]/div[4]/div[1]/div[1]/div[3]/ul[1]/li[1]/a[1]/div[1]/div[1]/div[2]/span[1]/div[1]/div[1]")
