...
Namespace Rates.CNBC
    Friend Class CCnbc : Implements IRateProvider
        ...
        Friend Function GetNewRates(providerIds As IEnumerable(Of String)) As IEnumerable(Of CRate) Implements IRateProvider.GetNewRates
            ...
            Dim url = "https://www.cnbc.com/quotes/" & Symbol
            ...
            Dim result = navigator.SelectSingleNode("/html[1]/body[1]/div[2]/div[1]/div[1]/div[3]/div[1]/div[1]/div[1]/div[2]/div[3]/div[1]/div[2]/span[1]")
